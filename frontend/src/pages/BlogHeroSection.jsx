...
const BlogHeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-blue-950 to-black text-white">
      <div className="container mx-auto px-6 md:px-10 min-h-screen flex items-center justify-center">
        <div className="grid md:grid-cols-2 gap-12 items-center py-12 w-full">
          
          <div className="space-y-8 relative z-10 max-w-xl mx-auto md:mx-0 px-2">
            ...
            <p className="text-lg md:text-xl text-blue-200 opacity-90 max-w-prose leading-relaxed">
          ...
          <div className="hidden md:flex justify-center items-center relative z-10">
            <div 
              ...
              className="relative bg-gradient-to-br from-blue-800/80 to-blue-900/80 rounded-2xl p-12 shadow-2xl backdrop-blur-sm hover:scale-105 transition-transform duration-300 border border-blue-700/30 cursor-pointer"
            >
